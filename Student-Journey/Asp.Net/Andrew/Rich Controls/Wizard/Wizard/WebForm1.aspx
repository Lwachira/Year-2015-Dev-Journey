...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Wizard ID="Wizard1" runat="server" DisplaySideBar="False" ActiveStepIndex="0" BackColor="#F7F6F3" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="0.8em" CssClass="auto-style2" Height="197px" Width="256px" OnFinishButtonClick="Wizard1_FinishButtonClick">
                ...
                <WizardSteps>
                    ...
                    <asp:WizardStep runat="server" Title="Step 2 - Data Collection">
                        ...
                        <asp:Calendar ID="Calendar1" runat="server" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" CellPadding="1" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="#003399" Height="200px" OnDayRender="Calendar1_DayRender" Width="220px" OnSelectionChanged="Calendar1_SelectionChanged" SelectedDate="2015-05-09" VisibleDate="2015-05-09">
                    ...
                    <asp:WizardStep runat="server" Title="Step 3 - Display">
                        <asp:Label ID="Label1" runat="server" CssClass="auto-style3" Font-Size="XX-Large" Height="100px" Text="Your Information" Width="249px"></asp:Label>
                        <br />
