...
name = 'Tom'
while name != 'John':
	name = raw_input('Enter your name') #Asks the user to enter a new name, store what they enter in the variable name
...
#	Then, create a while loop that encodes that while 'start' is not even (ie divisible by 2 with no remainder), will print out the value of 'start', and then add 1 to it.
...
#	Print the list out at the end to see if it’s working  and run it a few times by yourself with different input to check if it's working correctly - it's all about practice!
#
...
#	Only using one if condition, have the program output "True" when the users integer is bigger than the random integer and another 'True' if the integer is also even.
#
#==================================================================================================
