...
print stringList[0] #prints 0th element of list, John. the 0th element of a list is also known as the first element of a list, or the 'element at index 1'.

print stringList[1:2] #prints everything from the 1st to the 2nd element of list, NOT including the 2nd element. So only prints the item in the 1th position #which is Mary
...
stringList.append("Mary") #We can add to the end of a list like this. This is important! We don't want to lose what is already on the list -> the safest bet is
...
#	Now define a list called friends_ages, that stores the age of the each of your friends in a corresponding manner - ie the first entry of this list is the age of the friend named first in your other list.
#
#==================================================================================================
...
num_till_10 = xrange(0,10) # This will create a list of integers =[0, 1,2,3,4,5,6,7,9] and store it in the variable 'num_till_10'

num_till_5 = xrange(0,5) 

num_2_till_5 = xrange(2,5)
...
#	Remember the modulo command - ie %. 10%5 will give you the remainder of 10 divided by 5. 10 divided by 5 equals 2 with remainder of 0, hence this statement returns 0.
